...
public class CartController {
   ...
   private  final CartService cartService;
    ...
    @PostMapping("/add")
    CartDto addMicroSkillToCart(@RequestBody @Valid MicroSkill microSkill) {
        log.debug("Add microSkills: received cart data: {}", microSkill);
        return cartService.addMicroSkillToCart(microSkill);
    }
